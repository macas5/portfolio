...
const About = () => {
  return (
    <div id='about' className='flex flex-wrap'>
      <article className='w100 w-40-l center shadow-1 ma3 tl'>
      ...
      <article className='w100 w-40-l center shadow-1 ma3 tl flex flex-wrap'>
        <h2 className='center'>What can I do?</h2>
        <p className='ma3'>My knowledge includes these languages and frameworks:</p>
